...
export const VitalSignsSnapshotSchema = z.object({
  ...
  labs: z.object({
    ...
    cohb: z.number().optional(),
    roxIndex: z.number().optional(),
    pH: z.number().optional(),
    pCO2: z.number().optional(),
    ...
    anionGap: z.number().optional(),
    effectiveOsmolality: z.number().optional()
  }).optional(),
  resp: z.object({
...
export const ClinicalCaseSchema = z.object({
  metadata: z.object({
    ...
    title: z.string(),
    category: z.enum(["cardio","respiratory","metabolic","toxicological","pediatric","other"]),
    severity: z.enum(["critical","urgent","stable-unstable","stable"]),
  ...
  patient: z.object({
    ...
    ageInMonths: z.number().min(0).max(1440).optional(),
