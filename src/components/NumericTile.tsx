  ...
  return (
    <div className={cn(
      ...
      <div className="flex flex-col items-end mt-auto">
        <span className="text-4xl sm:text-5xl lg:text-6xl font-mono leading-none tracking-tighter" style={{ color }}>{value}</span>
        {subValue && <span className="text-sm sm:text-base lg:text-lg font-mono mt-1 text-zinc-400">{subValue}</span>}
      </div>
    </div>
  );
}
